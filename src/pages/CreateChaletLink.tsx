...
const CreateChaletLink = () => {
  ...
  return (
    <div className="min-h-screen" dir="rtl">
      ...
      <div className="container mx-auto px-4 py-12 -mt-20 relative z-10 max-w-3xl">
        <Button
          variant="ghost"
          onClick={() => navigate("/services")}
        ...
        <Card className="p-8 bg-gradient-to-br from-card to-card/50 backdrop-blur-sm border-2 border-border shadow-elevated">
